...
document.addEventListener('DOMContentLoaded', function() {
    ...
    $('.slider').slick({
        infinite: true,         // يلف علطول ميبدأش من الأول فجأة
        autoplay: true,         // يقلب لوحده
        autoplaySpeed: 3000,    // يستنى 3 ثواني بين كل قلبة
        speed: 1000,            // وقت الحركة نفسها (تخليها ناعمة وسموث)
        cssEase: 'ease-in-out', // انسيابية الحركة في البداية والنهاية
        slidesToShow: 4,        // عدد الكاردات في الشاشة الكبيرة
        slidesToScroll: 1,      // يقلب كارد واحد بس في المرة
        dots: false,            // مش محتاجين النقط في الشاشة الكبيرة
        useTransform: true,     // عشان الأداء يبقى أحسن (GPU)
        
        // ربط الأسهم اللي إنت مصممها بالـ CSS
        prevArrow: '.featuredProduct .arrows div:first-child',
        nextArrow: '.featuredProduct .arrows div:last-child',
        
        // إعدادات التجاوب مع مقاسات الشاشات المختلفة
        responsive: [
            {
                breakpoint: 1200, // شاشات اللابتوب المتوسطة
                settings: {
                    slidesToShow: 3,
                }
            },
            {
                breakpoint: 992,  // شاشات التابلت
                settings: {
                    slidesToShow: 2,
                }
            },
            {
                breakpoint: 576,  // الموبايل
                settings: {
                    slidesToShow: 1,
                    arrows: false, // نخفي الأسهم في الموبايل عشان الشاشة ضيقة
                    dots: true     // نفتح النقط عشان اليوزر يعرف يقلب بإيده
                }
            }
        ]
    });
...
document.addEventListener('DOMContentLoaded' , () => {
    ...
    setTimeout( function(){
        document.querySelector('.cards2').innerHTML = items
    }, 1500)
})
